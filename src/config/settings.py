...
class Settings(BaseSettings):
    ...
    TEST_DATABASE_URL: Optional[str] = Field(
        None,
        description='Test database URL (overrides DATABASE_URL in test environment)',
    )
    ...
    RATE_LIMIT_CLEANUP_FREQUENCY_HOURS: int = Field(
        ...
        gt=0,
        le=24,
        description='Rate limit cleanup frequency in hours',
    )
